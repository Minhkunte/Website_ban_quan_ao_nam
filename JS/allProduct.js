...
var listLocalHandbag = function() {
    ...
    for(var i in productHandbag) {
        ...
        listHandbag += '<p class="price" style="color: #DC143C;"><del>'+ data.price_sale +'</del></p>';
...
var listLocalPerfume = function() {
    ...
    for(var i in productPerfume) {
        ...
        listPerfume += '<p class="price" style="color: #DC143C;"><del>'+ data.price_sale +'</del></p>';
...
var listLocalHat = function() {
    ...
    for(var i in productHat) {
        ...
        listHat += '<p class="price" style="color: #DC143C;"><del>'+ data.price_sale +'</del></p>';
...
var listLocalShoe = function() {
    ...
    for(var i in productShoe) {
        ...
        listShoe += '<p class="price" style="color: #DC143C;"><del>'+ data.price_sale +'</del></p>';
